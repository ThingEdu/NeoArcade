"""FlappyDe — vòng lặp chính: ghép input · engine · ui · storage.
  ...
  python -m neoarcade.app --profile keyboard   # bàn phím (demo)
  python -m neoarcade.app --profile thingbot    # nút ThingBot (tự fallback nếu thiếu)
"""
...
from neoarcade.ui.render import Renderer
...
def main():
    ap = argparse.ArgumentParser(description="FlappyDe — NeoArcade")
