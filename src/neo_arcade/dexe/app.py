"""Đua Xe Dế — vòng lặp chính (lái bằng trục: A/D, ←/→ hoặc cần analog ThingBot).
  ...
  python -m neo_arcade.dexe.app --profile keyboard
"""
...
from neo_arcade.dexe.game import RaceController
from neo_arcade.dexe.render import RaceRenderer
from neo_arcade.input.profiles import get_steer_profile
...
def run(profile_name="keyboard", db_path="neo_arcade.db", sound=True):
    ...
    pygame.display.set_caption("Đua Xe Dế — NEO Arcade · Dế Foundation")
...
def main():
    ap = argparse.ArgumentParser(description="Đua Xe Dế — NEO Arcade")
