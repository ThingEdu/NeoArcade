"""Bóng Rổ Dế — vòng lặp chính (nút bấm / ThingBot). python -m neo_arcade.bongro.app"""
...
from neo_arcade.bongro.render import BasketRenderer
...
def run(profile_name="keyboard", db_path="neo_arcade.db", sound=True):
    ...
    pygame.display.set_caption("Bóng Rổ Dế — NEO Arcade · Dế Foundation")
...
def main():
    ap = argparse.ArgumentParser(description="Bóng Rổ Dế — NEO Arcade")
