...
make test        # 41 test (engine/storage/input/controller × 2 game)
```
Hoặc: `.venv/bin/python -m neoarcade.app` · `.venv/bin/python -m neoarcade.dexe.app`
...
src/neoarcade/
  ...
  input/profiles.py    # hồ sơ điều khiển: keyboard / thingbot (neo-hw) / jumppad + steer (lái)
